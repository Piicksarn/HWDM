...
Point Agent::bound_x(Point x) {
    ...
    if(x.y < y_low_bound)
        x.y = y_low_bound;
    // if(x.y > goal.height + goal.y)
    //     x.y = goal.height + goal.y;
    // if(x.y > src.cols - goal.height)
    //     x.y = src.cols - goal.height;
    // Low bound
    // if(x.y + goal.height > goal.height + goal.y)
    //     x.y = goal.height + goal.y;
    // if(x.y + goal.height >= src.rows)
    //     x.y = src.rows - goal.height;
    // if(x.y + goal.height >= src.rows)
    //     x.y = src.rows - goal.height;
    // if(x.y + goal.height < goal.height - goal.y)
    //     x.y = goal.height - goal.y;
